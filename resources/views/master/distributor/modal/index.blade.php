        ...
        <div class="modal-dialog modal-m">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formDistributor" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="nohp" class="col-sm-12 form-label">No.HP</label>
                                <div class="col-sm-12">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="alamat" class="col-sm-12 form-label">Alamat</label>
                                <div class="col-sm-12">
